...
class SelfAttention(nn.Module):
    ...
    def forward(self, values, keys, query, mask):
        ...
        #queries_length: (N, query_len, heads, heads_dim)
        #values_length: (N, values_len, heads, heads_dim)
        #keys_length: (N, key_len, heads, heads_dim)
        #energy_lenght: (N, heads, query_len, key_len)
...
if __name__ == "__main__":
    ...
    X =  torch.tensor([[1,5,6,4,3,9,5,2,5], [1,8,7,3,4,5,6,7,2]]).to(device)
